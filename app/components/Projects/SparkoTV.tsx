            ...
            <motion.div
                ...
                <div style={{ height: 270, width: 480, position: 'relative' }} className='self-center'>
                    <div ref={tvRef} className='absolute z-20 top-0 left-0 h-full w-full'>
                        <Image src={`${baseURL}/TV1.svg`} alt="Supplant TV App Image" style={{ width: '400px', height: 'auto' }} width={0} height={0}></Image>
                    </div>
                    <motion.div className='absolute z-30 top-0 left-0 h-full w-full'
                        ...
                        viewport={{ once: true }}
                    >
                        <Image src={`${baseURL}/TV2.svg`} alt="Supplant TV App Image" style={{ width: '400px', height: 'auto' }} width={0} height={0}></Image>
                    </motion.div>
                </div>
