...
const Br = () => <span className='my-2 block' />
const About = () => {
    return (
        <div className='min-h-screen flex flex-col items-center justify-center w-full' id="about">
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1, delay: 0.5 }} viewport={{ once: true }} className="flex flex-row pe-32 text-lg bg-background/50 dark:bg-white/5 rounded-lg py-8">
                ...
                <div>
                    ...
                    <section id="why-me" className="mb-16">
